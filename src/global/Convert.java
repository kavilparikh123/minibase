...
public class Convert {
	...
	/**
	 * reads 2 bytes from the given byte array at the specified position convert it
	 * to a character
	 * 
	...
	/**
	 * read 4 bytes from given byte array at the specified position convert it to a
	 * float value
	 * 
	 * @param data     a byte array
	...
	/**
	 * read 4 bytes from given byte array at the specified position convert it to an
	 * integer
	 * 
	 * @param data     a byte array
	 * @param position in data[]
	...
	/**
	 * read 2 bytes from given byte array at the specified position convert it to a
	 * short integer
	 * 
	 * @param data     a byte array
	 * @param position the position in data[]
	 ...
	 * given byte array at the specified position
	 * 
	 * @param data     a byte array
	 * @param position the position in data[]
