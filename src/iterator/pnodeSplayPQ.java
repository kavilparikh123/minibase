...
public class pnodeSplayPQ extends pnodePQ {
	 ...
	 */
	public void enq(pnode item) throws IOException, UnknowAttrType, TupleUtilsException, InvalidFieldNo {
		count++;
		...
		if ((l.rt = t.lt) != null)
			l.rt.par = l;
		if ((t.lt = pnodeSplayNode.dummy.rt) != null)
			t.lt.par = t;
		if ((t.rt = pnodeSplayNode.dummy.lt) != null)
			t.rt.par = t;
		t.par = null;
		root = t;
