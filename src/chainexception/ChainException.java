...
/**
 * This class is used for error handling. Errors are traced from different layer
 * of the minibase system.
 */
public class ChainException extends Exception {
	public Exception prev = null;

	/**
	 * Default constructor. It will probably never be used since every exception
