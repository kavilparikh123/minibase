...
class BufHashTbl implements GlobalConst {
	...
	/**
	 * Find a page in the hashtable, return INVALID_PAGE on failure, otherwise the
	 * frame number.
	 * 
	 * @param pageNo page number in the bucket.
	 */
...
public class BufMgr implements GlobalConst {
	 ...
	 */
	private void privFlushPages(PageId pageid, int all_pages) throws HashOperationException, PageUnpinnedException,
...
class Clock extends Replacer {
	 ...
	 * Pin the victim so that other process can not pick it as a victim.
	 *
...
class FrameDesc implements GlobalConst {
	...
	/**
	 * the dirty bit, 1 (TRUE) stands for this frame is altered, 0 (FALSE) for clean
	 * frames.
	 */
