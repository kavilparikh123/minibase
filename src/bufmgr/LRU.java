...
/**
 * class LRU is a subclass of class Replacer using LRU algorithm for page
 * replacement
 */
class LRU extends Replacer {
	...
	/**
	 * calll super class the same method pin the page in the given frame number move
	 * the page to the end of list
	 *
	...
	/**
	 * Calling super class the same method Initializing the frames[] with number of
	 * buffer allocated by buffer manager set number of frame used to zero
	 *
