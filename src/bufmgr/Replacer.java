...
abstract class Replacer implements GlobalConst {
	 ...
	 *
	 * @param frameNo frame number of the page.
	 * @throws InvalidFrameNumberException if the frame number is less than zero or
	 *                                     bigger than number of buffers.
	...
	/**
	 * Sets the buffer manager to be eqaul to the buffer manager in the argument,
	 * gets the total number of buffer frames, and mainstains the head of the clock.
	 *
...
/**
 * This interface assocaites with the replace algorithm, it describs if a buffer
 * frame page is pinned, unpinned, or available.
 */
class STATE {
