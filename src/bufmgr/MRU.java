...
/**
 * class MRU is a subclass of class Replacer using MRU algorithm for page
 * replacement
 */
class MRU extends Replacer {
	 ...
	 * MRU policy Update the buffer pool
	 * 
	 ...
	 * buffer allocated by buffer manager set each element of frame[] < 0
	 *
	...
	/**
	 * Adding the frame with given frame number to buffer pool putting it in front
	 * of the list
	 *
