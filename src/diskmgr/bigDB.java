...
//Change of DB into bigDB in order to implement bigtable based database in minibase 
public class bigDB implements GlobalConst {
    ...
    //Change in the function in order to display the read operation count
  ...
  //Change in the function in order to display the write operation count
