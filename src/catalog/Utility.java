...
public class Utility implements Catalogglobal {
	...
	/*
	 * CHecks to see if a string is a valid float. Nothing special. ["-" | ""]
	 * [0..9]+ ["." | ""] [0..9]+
	 */
	...
	public static void insertRecordUT(String relation, int attrCnt, attrNode[] attrList) throws Exception {
...
//---------------------------------------------------
	...
	public static void insertRecUT(String relation, int attrCnt, attrNode[] attrList) throws Exception {
		RelDesc relRec = null;
		RID rid = null;
		int status;
...
// CREATE TUPLE  
		...
		count = ExtendedSystemDefs.MINIBASE_ATTRCAT.getTupleStructure(relation, count, typeArray, sizeArray);
