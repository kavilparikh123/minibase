...
public class AttrCatalog extends Heapfile implements GlobalConst, Catalogglobal {
	...
	AttrCatalog(String filename)
			throws java.io.IOException, HFException, HFDiskMgrException, HFBufMgrException, AttrCatalogException {
		super(filename);
	...
	public void getInfo(String relation, String attrName, AttrDesc record) throws Catalogmissparam, Catalogioerror,
			Cataloghferror, AttrCatalogException, IOException, Catalogattrnotfound {
		int recSize;
		RID rid = null;
		Scan pscan = null;
	...
	public int getRelInfo(String relation, int attrCnt, AttrDesc[] Attrs)
			throws Catalogmissparam, Catalogioerror, Cataloghferror, AttrCatalogException, IOException, Catalognomem,
	...
	public int getTupleStructure(String relation, int attrCnt, AttrType[] typeArray, short[] sizeArray)
			throws Catalogmissparam, Catalogioerror, Cataloghferror, AttrCatalogException, IOException, Catalognomem,
			Catalogindexnotfound, Catalogattrnotfound, Catalogrelnotfound {
		int status;
		int stringcount = 0;
		AttrDesc[] attrs = null;
		int i, x;
