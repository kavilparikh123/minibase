...
public class RelCatalog extends Heapfile implements GlobalConst, Catalogglobal {
	...
	public void addIndex(String relation, String attrName, IndexType accessType, int buckets)
			throws RelCatalogException, IOException, Catalogioerror, Cataloghferror, Catalogmissparam,
			java.lang.Exception, Catalogindexnotfound, Catalognomem, Catalogbadtype, Catalogattrnotfound, Exception
	...
	public void createRel(String relation, int attrCnt, attrInfo[] attrList) throws Catalogmissparam, Catalogrelexists,
			Catalogdupattrs, Catalognomem, IOException, RelCatalogException, Catalogioerror, Cataloghferror {
		Heapfile rel;
		RelDesc rd = null;
		AttrDesc ad = null;
		int tupleWidth = 0;
	...
	public void getInfo(String relation, RelDesc record) throws Catalogmissparam, Catalogioerror, Cataloghferror,
			RelCatalogException, IOException, Catalogrelnotfound {
		int recSize;
		RID rid = null;
		Scan pscan = null;
